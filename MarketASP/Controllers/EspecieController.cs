...
namespace MarketASP.Controllers
{
    ...
    public class EspecieController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0117", xcode);
        ...
        public ActionResult Create()
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0118", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0119", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
        ...
        public async Task<ActionResult> DeleteEspe(int? id)
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0120", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
