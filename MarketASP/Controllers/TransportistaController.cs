...
namespace MarketASP.Controllers
{
    ...
    public class TransportistaController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0150", xcode);
        ...
        public ActionResult Create()
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0151", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0152", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
        ...
        public async Task<ActionResult> Deletetran(int? id)
        {
            ...
            db.Pr_PermisoAcceso(User.Identity.Name, "0153", xcode);
            xvalue = int.Parse(xcode.Value.ToString());
            if (xvalue == 0)
            {
                ViewBag.mensaje = "No tiene acceso, comuniquese con el administrador del sistema";
